...
---@class Sallo.App.Layout.LeaderboardBig : Tabullet.UILayout
---@field PROJ Sallo.App
---@field new fun(self:Tabullet.UIScene, attachedScreen:Tabullet.Screen, projNamespace:Sallo.App):Sallo.App.Layout.LeaderboardBig
local SCENE_L = class("Sallo.App.Layout.LeaderboardBig", TBL.UILayout)
...
function SCENE_L:make_grid()
    ...
    title_textblock:setText("LeaderboardBig")
...
function SCENE_L:make_grid_main(grid_p)
    ...
    grid_main:setHorizontalSetting({ "*", "14*", "5*", "15*", "11*", "*" })
